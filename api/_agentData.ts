...
export const allAgents: ApiAgent[] = [
  ...
  // HCC (7)
  { id: 'dispatch', name: 'Dispatch', subtitle: 'HOS Compliance Monitor', icon: 'Shield', status: 'active', statusLabel: 'Active', accent: 'blue', division: 'hcc', divisionName: 'IC Construction', metrics: [{ label: 'Watching', value: '2,800 employees across 7 divisions' }, { label: 'Violations prevented', value: '23 this month' }, { label: 'Savings this month', value: '$368K' }, { label: 'False alarm rate', value: '0.8%' }], description: 'Monitors FRA Hours-of-Service compliance across all 7 IndustrialsCo divisions in real time.', category: 'safety' , instances: 14, tasksToday: 1920, tasksThisWeek: 12480, uptimePercent: 99.99},
