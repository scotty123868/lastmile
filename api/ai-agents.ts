...
function generateAgentMetrics(): AgentMetrics[] {
  ...
  return [
    ...
    },
    {
      ...
      status: 'active',
      lastRun: new Date(Date.now() - Math.random() * 180000).toISOString(),
      accuracy: jitter(96.1, 2),
      falsePositiveRate: jitter(1.8, 1),
      meanDecisionTimeMs: Math.round(jitter(15000, 3000)),
      humanOverrideRate: jitter(5.4, 3),
      eventsProcessed24h: Math.round(jitter(14, 5)),
      savingsGenerated: 0,
      confidenceThreshold: 0.85,
    },
    {
      ...
      status: 'active',
      lastRun: new Date(Date.now() - Math.random() * 120000).toISOString(),
      accuracy: jitter(93.8, 2),
      falsePositiveRate: jitter(3.4, 1.5),
      meanDecisionTimeMs: Math.round(jitter(5000, 1200)),
      humanOverrideRate: jitter(9.2, 4),
      eventsProcessed24h: Math.round(jitter(89, 15)),
      savingsGenerated: 0,
      confidenceThreshold: 0.75,
    },
    {
      ...
      status: 'active',
      lastRun: new Date(Date.now() - Math.random() * 60000).toISOString(),
      accuracy: jitter(91.4, 3),
      falsePositiveRate: jitter(4.8, 2),
      meanDecisionTimeMs: Math.round(jitter(2800, 700)),
      humanOverrideRate: jitter(15.6, 5),
      eventsProcessed24h: Math.round(jitter(12000, 1000)),
      savingsGenerated: 0,
      confidenceThreshold: 0.70,
    },
    {
