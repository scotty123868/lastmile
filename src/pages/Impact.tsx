...
const impactData: Record<string, CompanyImpactData> = {
  ...
  'nb-aerospace': {
    totalAnnualImpact: 12000000,
    categories: [
      { label: 'Certification Automation', amount: 4800000, description: 'FAA/EASA documentation automation, airworthiness directive tracking, and certification workflow acceleration', icon: 'shield', type: 'saving' },
      { label: 'Parts Traceability', amount: 3600000, description: 'AI-powered parts genealogy, counterfeit detection, and supply chain verification across aircraft programs', icon: 'shield', type: 'saving' },
      { label: 'MRO Optimization', amount: 4800000, description: 'Maintenance scheduling optimization, parts forecasting, and turnaround time reduction', icon: 'zap', type: 'saving' },
      { label: 'Implementation Cost', amount: -1200000, description: 'Platform license, aviation systems integration, and specialized training', icon: 'cost', type: 'cost' },
    ],
    waterfall: [
      { label: 'Certification', value: 4800000, type: 'positive' },
      { label: 'Traceability', value: 3600000, type: 'positive' },
      { label: 'MRO', value: 4800000, type: 'positive' },
      { label: 'Costs', value: -1200000, type: 'negative' },
      { label: 'Net Impact', value: 12000000, type: 'total' },
    ],
    metrics: [
      { label: 'Payback Period', value: '4.2 mo' },
  ...
  'nb-energy': {
    totalAnnualImpact: 14000000,
    categories: [
      { label: 'Grid Optimization', amount: 5600000, description: 'AI-driven load balancing, demand response automation, and distribution network optimization', icon: 'zap', type: 'saving' },
      { label: 'Outage Prevention', amount: 4200000, description: 'Predictive failure analysis, vegetation management, and storm damage prevention', icon: 'shield', type: 'saving' },
      { label: 'Meter Efficiency', amount: 5600000, description: 'Smart meter analytics, billing accuracy improvement, and revenue protection', icon: 'users', type: 'saving' },
      { label: 'Implementation Cost', amount: -1400000, description: 'Platform license, SCADA/OMS integration, and utility workforce training', icon: 'cost', type: 'cost' },
    ],
    waterfall: [
      { label: 'Grid', value: 5600000, type: 'positive' },
      { label: 'Outage', value: 4200000, type: 'positive' },
      { label: 'Metering', value: 5600000, type: 'positive' },
      { label: 'Costs', value: -1400000, type: 'negative' },
      { label: 'Net Impact', value: 14000000, type: 'total' },
    ],
    metrics: [
      { label: 'Payback Period', value: '4.6 mo' },
  ...
  'nb-financial': {
    totalAnnualImpact: 9000000,
    categories: [
      { label: 'KYC/AML Automation', amount: 3600000, description: 'Customer identity verification, sanctions screening, and ongoing due diligence automation', icon: 'shield', type: 'saving' },
      { label: 'Fraud Prevention', amount: 2700000, description: 'Real-time transaction monitoring, pattern analysis, and suspicious activity reporting', icon: 'shield', type: 'saving' },
      { label: 'Regulatory Compliance', amount: 3600000, description: 'Automated regulatory reporting, policy enforcement, and exam preparation across jurisdictions', icon: 'zap', type: 'saving' },
      { label: 'Implementation Cost', amount: -900000, description: 'Platform license, core banking integration, and compliance team training', icon: 'cost', type: 'cost' },
    ],
    waterfall: [
      { label: 'KYC/AML', value: 3600000, type: 'positive' },
      { label: 'Fraud', value: 2700000, type: 'positive' },
      { label: 'Regulatory', value: 3600000, type: 'positive' },
      { label: 'Costs', value: -900000, type: 'negative' },
      { label: 'Net Impact', value: 9000000, type: 'total' },
    ],
    metrics: [
      { label: 'Payback Period', value: '3.6 mo' },
  ...
  'nb-health': {
    totalAnnualImpact: 15000000,
    categories: [
      { label: 'Clinical Trials Acceleration', amount: 5400000, description: 'Patient recruitment optimization, protocol adherence monitoring, and data management automation', icon: 'users', type: 'saving' },
      { label: 'Drug Safety Monitoring', amount: 4200000, description: 'Adverse event detection, signal analysis, and pharmacovigilance reporting automation', icon: 'shield', type: 'saving' },
      { label: 'Manufacturing Quality', amount: 6900000, description: 'Batch release optimization, deviation management, and GMP compliance automation', icon: 'zap', type: 'saving' },
      { label: 'Implementation Cost', amount: -1500000, description: 'Platform license, LIMS/MES integration, and GxP-validated training rollout', icon: 'cost', type: 'cost' },
    ],
    waterfall: [
      { label: 'Trials', value: 5400000, type: 'positive' },
      { label: 'Drug Safety', value: 4200000, type: 'positive' },
      { label: 'Manufacturing', value: 6900000, type: 'positive' },
      { label: 'Costs', value: -1500000, type: 'negative' },
      { label: 'Net Impact', value: 15000000, type: 'total' },
    ],
    metrics: [
