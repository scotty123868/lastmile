...
const integrationData: Record<string, CompanyIntegrationData> = {
  meridian: {
    ...
    integrations: [
      ...
      { id: 'i3', name: 'eCMS', category: 'ERP', status: 'syncing', lastSync: 'Syncing now', recordsSynced: 248000 },
  ...
  hcc: {
    ...
    integrations: [
      ...
      { id: 'i3', name: 'eCMS — HCC Instance', category: 'ERP', status: 'syncing', lastSync: 'Syncing now', recordsSynced: 124000 },
      { id: 'i4', name: 'HCSS Telematics', category: 'Fleet Telematics', status: 'connected', lastSync: '1 min ago', recordsSynced: 1420000 },
  ...
  hrsi: {
    ...
    integrations: [
      ...
      { id: 'i2', name: 'CMMS', category: 'Work Orders', status: 'connected', lastSync: '5 min ago', recordsSynced: 84200 },
      { id: 'i3', name: 'MCP', category: 'Workforce Management', status: 'connected', lastSync: '3 min ago', recordsSynced: 48000 },
  ...
  htsi: {
    ...
    integrations: [
      ...
      { id: 'i4', name: 'MCP', category: 'Workforce Management', status: 'connected', lastSync: '5 min ago', recordsSynced: 48000 },
